package com.esprit.myfirstproject.utils;
...
//    Advice 1 : consittuée du pointcat
    @Before("execution(* com.esprit.myfirstproject.services.*.*(..))") // le string écrit est le pointcat
...
//        Advice 2 : consittuée du pointcat
    ...
    @After("execution(* com.esprit.myfirstproject.services.*.*(..))")
